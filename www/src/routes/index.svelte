...
<section>
    <div class="p-2 flex flex-col space-y-16 h-full">
        <div class="grid grid-cols-8 grid-rows-8 w-full text-gray-700">
            ...
            <div class="bg-gray-600 row-start-1 row-end-2 col-start-4 col-end-6 border-black border-b-2 flex flex-col">
                <Room name="Bathroom" states="{states}" ws={ws}/>
            </div>

            <div class="row-start-1 row-end-3 col-start-2 col-end-4 border-black border-b-2 border-r-2 transition-all duration-500 ">
                <Room name="Bedroom" states="{states}" ws={ws}/>
            </div>

            <div class="row-start-3 row-end-6 col-start-2 col-end-4 border-black border-r-2 transition-all duration-500 flex flex-col">
                <Room name="Kitchen" states="{states}" ws={ws} sonos={sonos}/>
            </div>

            <div class="bg-lime-700 text-gray-100 row-start-1 row-end-6 col-start-1 col-end-2 p-2 border-black border-r-2">
